...
namespace kTVCSS.VKInteraction
{
    public static class Matches
    {
                    ...
                    using (var reader = await query.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            try
                            {
                                ...
                                player.WinRate = double.Parse(reader[1].ToString());
                                ...
                                player.HSR = double.Parse(reader[5].ToString());
                                player.KDR = double.Parse(reader[6].ToString());
                                player.AVG = double.Parse(reader[7].ToString());
        ...
        {
            System.Drawing.Image image = System.Drawing.Image.FromFile(@"Pictures\template_match_result.png");
            ...
            // DRAWING FIRST BLOCK
            Drawing.Tools.DrawText(graphics, (Math.Round(matchResultInfo.MVPlayer.WinRate, 2)).ToString() + "%", new Rectangle(285, 540, 0, 200), StringAlignment.Center, 36, Brushes.White, FontStyle.Regular, "Play-Regular");
            ...
            Drawing.Tools.DrawText(graphics, (Math.Round(matchResultInfo.MVPlayer.HSR, 2) * 100).ToString() + "%", new Rectangle(670, 540, 0, 200), StringAlignment.Center, 36, Brushes.White, FontStyle.Regular, "Play-Regular");
            Drawing.Tools.DrawText(graphics, Math.Round(matchResultInfo.MVPlayer.KDR, 2).ToString(), new Rectangle(795, 640, 0, 200), StringAlignment.Far, 18, Brushes.White, FontStyle.Regular, "Play-Regular");
            Drawing.Tools.DrawText(graphics, Math.Round(matchResultInfo.MVPlayer.AVG, 2).ToString(), new Rectangle(795, 690, 0, 200), StringAlignment.Far, 18, Brushes.White, FontStyle.Regular, "Play-Regular");
            // DRAWING THIRD BLOCK
            ...
            for (int i = 0; i < FirstTeam.Count(); i++)
            {
                ...
                Drawing.Tools.DrawText(graphics, Math.Round(FirstTeam.ElementAt(i).KDR, 2).ToString(), new Rectangle(585, yForNumbers, 0, 200), StringAlignment.Center, 18, Brushes.White, FontStyle.Regular, "Play-Regular");
                yForNames += 57;
                yForNumbers += 56;
            }
            ...
            for (int i = 0; i < SecondTeam.Count(); i++)
            {
                ...
                Drawing.Tools.DrawText(graphics, Math.Round(SecondTeam.ElementAt(i).KDR, 2).ToString(), new Rectangle(1147, yForNumbers, 0, 200), StringAlignment.Center, 18, Brushes.White, FontStyle.Regular, "Play-Regular");
                yForNames += 57;
                yForNumbers += 56;
            }
